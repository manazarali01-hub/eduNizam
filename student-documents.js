(function(){
  ...
  function printCertificate(item){
    ...
    const institute=esc(st.schoolName||'EduNizam Institute'),clazz=esc((s.className||'-')+(s.sectionName?' - '+s.sectionName:'')),logo=st.schoolLogo?'<img class="school-logo" src="'+esc(st.schoolLogo)+'" alt="Institute logo">':'';
