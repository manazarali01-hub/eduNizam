...
if('serviceWorker'in navigator)navigator.serviceWorker.register('sw.js?v=20260921-auth72',{updateViaCache:'none'}).then(r=>r.update()).catch(()=>{});
renderAll();
