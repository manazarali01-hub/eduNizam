(function(){
  ...
  add({
    id:"pectaa-grade9-pairing-2026",board:"Punjab Boards / PECTAA",classLevels:[9],
  ...
  add({
    id:"pectaa-grade11-pairing-2026",board:"Punjab Boards / PECTAA",classLevels:[11],
    subject:"All Subjects",type:"Pairing Scheme",title:"Punjab Grade-11 Pairing Schemes + Smart Syllabus + Model Papers 2026",
    source:"official",url:"https://pectaa.edu.pk/curriculum-compliance/",
  ...
  add({
    id:"pectaa-tech9-pairing-2026",board:"Punjab Boards / PECTAA",classLevels:[9],
  ...
  add({
    id:"fsd-grade9-pairing-2026",board:"BISE Faisalabad",classLevels:[9],
    subject:"All Subjects",type:"Pairing Scheme",title:"BISE Faisalabad Grade-9 Revised Pairing Schemes & Model Papers 2026",
    source:"official",url:"https://web.bisefsd.edu.pk/NewsEvents.aspx",
  ...
  [9,10,11,12].forEach(cls=>add({
    id:"pectaa-books-"+cls,board:"Punjab / PECTAA",classLevels:[cls],
  ...
  add({
    id:"nbf-computer-9",board:"Federal / NBF",classLevels:[9],subject:"Computer Science",type:"Textbook",
    title:"NBF Computer Science Grade 9 Textbook",source:"official",
  ...
  add({
    id:"nbf-general-science-9",board:"Federal / NBF",classLevels:[9],subject:"General Science",type:"Textbook",
    title:"NBF General Science Grade 9 Textbook",source:"official",
  ...
  add({
    id:"nbf-textbook-chapters",board:"Federal / NBF",classLevels:[9,10,11,12],
    subject:"All Subjects",type:"Textbook",title:"NBF Official Textbook Chapters & Class 12 Books",
    source:"official",url:"https://www.nbf.org.pk/chapters-of-text-books",
  ...
  notes.forEach(([id,cls,subject,chapter,content])=>add({
    id,board:"EduNizam",classLevels:[cls],subject,type:"Notes",
    title:"Class "+cls+" "+subject+" — "+chapter+" Quick Notes",
    source:"built-in",chapter,content,
