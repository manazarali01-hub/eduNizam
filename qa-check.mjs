...
if(!login.includes('id="memberSchoolField"')) fail.push('Parent/Student school search field missing.');
if(!login.includes("search_school_directory_v1")) fail.push('Parent/Student school search RPC missing from login.');
...
if(!read('role-access-center.js').includes('Parent & Student Login Requests')) fail.push('Admin Parent/Student approval center missing.');
